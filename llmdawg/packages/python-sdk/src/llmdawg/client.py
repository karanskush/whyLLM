"""LLMDawgClient — thin HTTP client for the ingest API."""
...
class LLMDawgClient:
    """Low-level client for sending span data to the LLMDawg ingest API."""
    ...
    def __init__(
        ...
        self.api_key = api_key or os.environ.get("LLMDAWG_API_KEY", "")
        self.base_url = (
            base_url or os.environ.get("LLMDAWG_BASE_URL", "http://localhost:8000")
        ).rstrip("/")
    ...
    def __enter__(self) -> "LLMDawgClient":
        return self
