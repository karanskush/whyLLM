"""IngestWorker — async BRPOP consumer for the LLMDawg ingest queue.
...
from llmdawg_api.database import get_session_factory  # noqa: E402
from llmdawg_api.redis_client import get_redis  # noqa: E402
...
async def run_worker() -> None:
    ...
    log.info("Starting LLMDawg IngestWorker…")
