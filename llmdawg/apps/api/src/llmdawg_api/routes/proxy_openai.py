...
Usage:
    ...
    # LLMDawg never stores your OpenAI key — it is passed through as-is.

Features:
- Forwards all HTTP methods (GET, POST, DELETE, PATCH, PUT)
- Strips LLMDawg-internal and hop-by-hop headers before forwarding
...
async def proxy_openai(
    ...
    """Forward any OpenAI API request through the LLMDawg proxy."""
