...
from llmdawg_api.database import Base  # noqa: F401 — ensures models are loaded

# Trigger model registration (import any model modules here as they are added)
# from llmdawg_api.models import spans, traces, organizations  # noqa: F401

config = context.config
settings = get_settings()

# Override sqlalchemy.url with the value from pydantic-settings
# This lets alembic.ini stay generic (no secrets in config files)
